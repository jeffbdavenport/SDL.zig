...
pub extern fn IMG_Linked_Version() [*c]const SDL_version;
...
pub extern fn IMG_LoadTyped_RW(src: [*c]SDL_RWops, freesrc: c_int, @"type": [*c]const u8) [*c]SDL_Surface;
pub extern fn IMG_Load(file: [*c]const u8) [*c]SDL_Surface;
pub extern fn IMG_Load_RW(src: [*c]SDL_RWops, freesrc: c_int) [*c]SDL_Surface;
pub extern fn IMG_LoadTexture(renderer: ?*SDL_Renderer, file: [*c]const u8) ?*SDL_Texture;
pub extern fn IMG_LoadTexture_RW(renderer: ?*SDL_Renderer, src: [*c]SDL_RWops, freesrc: c_int) ?*SDL_Texture;
pub extern fn IMG_LoadTextureTyped_RW(renderer: ?*SDL_Renderer, src: [*c]SDL_RWops, freesrc: c_int, @"type": [*c]const u8) ?*SDL_Texture;
pub extern fn IMG_isICO(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isCUR(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isBMP(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isGIF(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isJPG(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isLBM(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isPCX(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isPNG(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isPNM(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isSVG(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isTIF(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isXCF(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isXPM(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isXV(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_isWEBP(src: [*c]SDL_RWops) c_int;
pub extern fn IMG_LoadICO_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadCUR_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadBMP_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadGIF_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadJPG_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadLBM_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadPCX_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadPNG_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadPNM_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadSVG_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadTGA_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadTIF_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadXCF_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadXPM_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadXV_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_LoadWEBP_RW(src: [*c]SDL_RWops) [*c]SDL_Surface;
pub extern fn IMG_ReadXPMFromArray(xpm: [*c][*c]u8) [*c]SDL_Surface;
pub extern fn IMG_SavePNG(surface: [*c]SDL_Surface, file: [*c]const u8) c_int;
pub extern fn IMG_SavePNG_RW(surface: [*c]SDL_Surface, dst: [*c]SDL_RWops, freedst: c_int) c_int;
pub extern fn IMG_SaveJPG(surface: [*c]SDL_Surface, file: [*c]const u8, quality: c_int) c_int;
pub extern fn IMG_SaveJPG_RW(surface: [*c]SDL_Surface, dst: [*c]SDL_RWops, freedst: c_int, quality: c_int) c_int;
...
pub const SDL_IMAGE_VERSION = @compileError("unable to translate C expr: unexpected token '{'"); // stubs/SDL2/SDL_image.h:45:9
...
pub inline fn __isctype(c: anytype, @"type": anytype) @TypeOf(__ctype_b_loc().*[@intCast(@import("std").zig.c_translation.cast(c_int, c))] & @import("std").zig.c_translation.cast(c_ushort, @"type")) {
    return __ctype_b_loc().*[@intCast(@import("std").zig.c_translation.cast(c_int, c))] & @import("std").zig.c_translation.cast(c_ushort, @"type");
}
...
pub inline fn __isctype_l(c: anytype, @"type": anytype, locale: anytype) @TypeOf(locale.*.__ctype_b[@intCast(@import("std").zig.c_translation.cast(c_int, c))] & @import("std").zig.c_translation.cast(c_ushort, @"type")) {
    return locale.*.__ctype_b[@intCast(@import("std").zig.c_translation.cast(c_int, c))] & @import("std").zig.c_translation.cast(c_ushort, @"type");
}
...
pub const SDL_IMAGE_MAJOR_VERSION = @as(c_int, 2);
pub const SDL_IMAGE_MINOR_VERSION = @as(c_int, 0);
pub const SDL_IMAGE_PATCHLEVEL = @as(c_int, 5);
pub const SDL_IMAGE_COMPILEDVERSION = SDL_VERSIONNUM(SDL_IMAGE_MAJOR_VERSION, SDL_IMAGE_MINOR_VERSION, SDL_IMAGE_PATCHLEVEL);
pub inline fn SDL_IMAGE_VERSION_ATLEAST(X: anytype, Y: anytype, Z: anytype) @TypeOf(SDL_IMAGE_COMPILEDVERSION >= SDL_VERSIONNUM(X, Y, Z)) {
